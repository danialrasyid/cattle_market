		...
		<div class="row align-items-center py-3 d-none d-lg-flex justify-content-between">
			<div class="col-lg-4 logo">
				<a href="{{ route('front.home') }}" class="text-decoration-none">
					<span class="h1 text-uppercase text-primary bg-dark px-2">Cattle</span>
	...
	<div class="container">
		<nav class="navbar navbar-expand-xl" id="navbar">
			<a href="{{ route("front.home") }}" class="text-decoration-none mobile-logo">
				<span class="h2 text-uppercase text-primary bg-dark">CATTLE</span>
				<span class="h2 text-uppercase text-white px-2">MARKET</span>
			</a>
		...
		<div class="row">
			<div class="col-md-4">
				<div class="footer-card">
					...
					123 Street, Malang, Jawa Timur <br>
			...
			<div class="row">
				<div class="col-12 mt-3">
					<div class="copy-right text-center">
						<p>© Copyright 2024 Cattle Market. All Rights Reserved</p>
					</div>
				</div>
			</div>
		</div>
